# Jiografia na Mazingira: Kitabu cha Mwanafunzi Darasa la 4 — ADT Bundle Reference
...
**Jiografia na Mazingira: Kitabu cha Mwanafunzi Darasa la 4** — Hiki ni kitabu cha Jiografia na Mazingira cha Darasa la 4, kinachowalenga wanafunzi wa shule ya msingi katika kiwango cha awali cha kati. Kutokana na vielelezo vinavyoonekana kama ramani sahili ya shule, vipimo vya umbali, mizani na matumizi ya kilometa na meta, kitabu kinafundisha uelewa wa mazingira ya karibu na stadi za msingi za kusoma na kutumia ramani. Kimeandikwa kwa Kiswahili na kwa muundo wake kinaonekana kutoka Tanzania au Afrika Mashariki, kikiwa na mkabala wa kufundisha kwa vielelezo, mazoezi ya vitendo na ujifunzaji unaohusisha mazingira halisi ya mwanafunzi.
...
```
JIOGRAFIA-NA-MAZINGIRA-DARASA-LA-4/
├── adt/                              # THE WEB APP
...
├── JIOGRAFIA-NA-MAZINGIRA-DARASA-LA-4.db                    # SQLite database (pipeline state)
├── JIOGRAFIA-NA-MAZINGIRA-DARASA-LA-4.pdf                   # Original source PDF
...
| `pg{NNN}_im{NNN}` | Image alt text / description | `pg003_im005` |
...
{
  "pg001_gp001_tx001": "",
  "pg003_im005": "Yaliyomo",
  "gl001": "akaunti",
  "gl001_def": "usajili wa mtumiaji unaomruhusu kutumia huduma fulani mtandaoni."
}
```
...
```json
{
  "akaunti": {
    "word": "akaunti",
    "definition": "usajili wa mtumiaji unaomruhusu kutumia huduma fulani mtandaoni.",
    "variations": ["akaunti","akaunti za"],
    "emoji": "👤🔐"
  }
}
```
...
```json
{
  "title": "Jiografia na Mazingira: Kitabu cha Mwanafunzi Darasa la 4",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "sw",
...
<body>
    <div id="content" class="opacity-0">
        <section role="article" data-section-type="text_and_single_image"
            ...
            <img data-id="pg003_im005" src="images/pg003_im005.png" ...>
...
| Original PDF | `JIOGRAFIA-NA-MAZINGIRA-DARASA-LA-4.pdf` |
| Pipeline database | `JIOGRAFIA-NA-MAZINGIRA-DARASA-LA-4.db` (SQLite) |
